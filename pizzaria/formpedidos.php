	...
	<table width="100%" border="0" cellspacing="0">
		<tr bgcolor="#666666">
			<td width="10%"><b><font size="2"
					face="Verdana, Arial, Helvetica, sans-serif" color="#FFFFFF">Código</font></b></td>
			<td width="74%"><b><font size="2"
					face="Verdana, Arial, Helvetica, sans-serif" color="#FFFFFF">Pizza</font></b></td>
			<td width="16%"><b><font size="2"
					face="Verdana, Arial, Helvetica, sans-serif" color="#FFFFFF">Valor
						(R$)</font></b></td>
		</tr>
		<?php
$linhasini = 1;
	...
	<table width="100%" border="0" cellspacing="0">
		...
		<tr>
			<td>
				...
				<input type="reset" name="Submti2" value="       Limpar       ">
			</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
		...
		<tr>
			<td><font face="Geneva, Arial, Helvetica, san-serif" size="2"><b><a
						href="index.php">Retornar</a></b></font></td>
		</tr>
	</table>
</form>